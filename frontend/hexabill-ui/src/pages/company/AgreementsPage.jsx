    ...
    <div className="p-3 md:p-4 w-full max-w-full">
      <div className="flex items-center justify-between mb-3 gap-2">
        <div>
          ...
          <p className="text-sm text-text-secondary">Create, edit, reprint, and delete business development agreements</p>
        </div>
        <Link
          to="/agreements/new"
      ...
      {loading ? (
        ...
        <div className="border rounded-lg p-8 text-center bg-white">
          ...
          <p className="text-sm text-text-secondary mb-4">Create your first agreement — fill Second Party details, then print PDF.</p>
          <Link
            to="/agreements/new"
