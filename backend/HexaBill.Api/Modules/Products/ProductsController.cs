...
namespace HexaBill.Api.Modules.Products
{
    [ApiController]
    ...
    public class ProductsController : TenantScopedController // MULTI-TENANT: Use TenantScopedController
    {
        ...
        private readonly HexaBill.Api.Core.Storage.IFileUploadService? _fileUploadService;
        ...
        public ProductsController(IProductService productService, IExcelImportService excelImportService, IServiceProvider serviceProvider, ISettingsService settingsService, IStockAdjustmentService stockAdjustmentService, IProductBarcodeLabelService barcodeLabelService, ILogger<ProductsController> logger)
        {
            ...
            _fileUploadService = serviceProvider.GetService<HexaBill.Api.Core.Storage.IFileUploadService>();
