    ...
    public class DiagnosticsController : ControllerBase
    {
        ...
        public async Task<IActionResult> SchemaCheck()
        {
            ...
            try
            {
                ...
                var criticalColumns = new[] { ("ErrorLogs", "ResolvedAt"), ("SaleReturns", "ReturnCategory"), ("SaleReturns", "ReturnType"), ("SaleReturnItems", "DamageCategoryId"), ("SaleReturnItems", "Condition"), ("SaleReturnItems", "StockEffect"), ("Sales", "BranchId"), ("Sales", "RouteId"), ("Branches", "IsActive"), ("Routes", "IsActive") };
