    ...
    public class SaleService : ISaleService
    {
        ...
        private async Task<SaleDto> CreateSaleInternalAsync(CreateSaleRequest request, int userId, int tenantId)
        {
            ...
            try
            {
                ...
                var sale = new Sale
                {
                    ...
                    VatScenario = isZeroInvoice ? VatScenarios.OutOfScope : (vatTotal > 0 ? VatScenarios.Standard : VatScenarios.ZeroRated),
                    CreatedBy = userId,
                    CreatedAt = DateTime.UtcNow
                };
        ...
        public async Task<SaleDto> UpdateSaleAsync(int saleId, CreateSaleRequest request, int userId, int tenantId, string? editReason = null, byte[]? expectedRowVersion = null)
        {
            ...
            try
            {
                ...
                saleForUpdate.VatScenario = isZeroInvoice ? VatScenarios.OutOfScope : (vatTotal > 0 ? VatScenarios.Standard : VatScenarios.ZeroRated);
