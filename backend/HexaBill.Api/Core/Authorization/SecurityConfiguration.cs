    ...
    public static class SecurityConfiguration
    {
        public static IServiceCollection AddSecurityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("AdminOrOwner", policy =>
                    policy.Requirements.Add(new HexaBill.Api.Core.Authorization.AdminOrOwnerRequirement()));
                options.AddPolicy("AdminOrOwnerOrStaff", policy =>
                    policy.Requirements.Add(new HexaBill.Api.Core.Authorization.AdminOrOwnerOrStaffRequirement()));
            });
            services.AddSingleton<Microsoft.AspNetCore.Authorization.IAuthorizationHandler, HexaBill.Api.Core.Authorization.AdminOrOwnerAuthorizationHandler>();
            services.AddSingleton<Microsoft.AspNetCore.Authorization.IAuthorizationHandler, HexaBill.Api.Core.Authorization.AdminOrOwnerOrStaffAuthorizationHandler>();
        ...
        private static bool IsAllowedProductionOrigin(string origin, IConfiguration configuration)
        {
            ...
            var subdomain = host.EndsWith(suffix, StringComparison.Ordinal)
                ? host[..^suffix.Length]
                : null;
            return subdomain != null && HexaBill.Api.Core.Tenancy.TenantSlugValidator.IsValid(subdomain);
        }
